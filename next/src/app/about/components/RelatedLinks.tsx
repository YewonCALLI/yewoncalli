...
export const RelatedLinks = ({ links }: RelatedLinkProps) => {
  return (
    <>
      <div className='w-full md:w-5/12 flex flex-col justify-start items-start gap-4 md:gap-2'>
        <span className='font-semibold text-sm'>
          Get in Touch 
          <GoArrowUpRight className='inline-block text-sm -translate-y-[1px] md:-translate-y-[2px]' />
        </span>
